...
@testset "cluster_regions" begin
    ...
    @test begin
        ...
        result = cluster_regions(regions, ROI)
        all(x -> x in ["gbr", "usa", "chn", "ind", "eur", "fra", "deu"], result)
    end

    # Test clustering with custom preserve list (without "eur")
    @test begin
        regions = [["gbr", "usa", "chn", "ind"]; get_eu_states()]
        regions = NamedArray(regions, regions)
    ...
    @test begin
        regions = [["gbr", "usa", "chn", "ind"]; get_eu_states()]
        regions = NamedArray(regions, regions)
        result = cluster_regions(regions, "gbr")
    ...
    @test begin
        ...
        regions = NamedArray(regions, regions)
        result = cluster_regions(regions, ["gbr", "chn"])
    ...
    @test begin
        regions = [["gbr", "usa", "chn", "ind"]; get_eu_states()]
        regions = NamedArray(regions, regions)
        result = cluster_regions(regions, ["gbr", "eur"])
    ...
    @test begin
        regions = [["gbr", "usa", "chn", "ind"]; get_eu_states()]
        regions = NamedArray(regions, regions)
        result = cluster_regions(regions, ["eur", "usa"])
